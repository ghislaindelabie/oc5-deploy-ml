# Git Branching Strategy - OC5 ML Deployment
...
|---------|------|------|-------------|
| v0.1.0 | 2025-11-19 | Initial | Production release: FastAPI + Docker + Tests |
| v1.0.0 | TBD | Major | Database integration (PostgreSQL + ORM) |
